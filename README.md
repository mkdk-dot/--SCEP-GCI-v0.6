...
# Ω-SCEP / GCI v0.6  
Self-Evolving AGI Coherence Framework
...
- EP: Evolution Pressure (drives change)
- GCI: General Coherence Index (maintains structural stability)
...
EP defines the system’s ability to evolve:

EP(S) = f(consistency, scope, adaptability, freedom, self_modification, novelty)
...
GCI measures structural coherence:
...
Score(C) = EP(C) + α·GCI(C) + β·Φ(contradiction)
...
I_ext = f(agent, human, institution, environment)
...
The designer maintains the system:
...
You are the Framework Designer.
